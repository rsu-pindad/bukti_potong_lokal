    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-lg-6 mb-lg-0 mb-4">
        <div class="card" style="border-radius: .5rem;">
          <div class="row g-0">
            <div class="col-md-4 gradient-custom text-dark text-center" style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
              ...
              <div class="card-body p-4">
                ...
                <div id="judulIdentitasPribadi" class="mb-2">
                  <h6 class="d-flex justify-content-between">
                    Identitas Pribadi
                    <x-inputs.button type="button" class="btn btn-outline-secondary btn-sm editPribadi" data-bs-toggle="modal" :data-bs-target="$bsTargetIdentitas" rootId="$bsTargetIdentitas" rootLabel="Identitas Pribadi">
                ...
                <div id="judulIdentitasKepegawaian" class="mb-2">
                  <h6 class="d-flex justify-content-between">
                    ...
                    <x-inputs.button type="button" class="btn btn-outline-secondary btn-sm editKepegawaian" data-bs-toggle="modal" :data-bs-target="$bsTargetPegawai">
                ...
                <div id="fakturPajak">
                  ...
                  <div class="row pt-1">
                    ...
                    <div class="col-12 mb-3">
                      ...
                      <p class="text-muted">
                        @if (Auth::user()->employee->is_setuju)
                        <div class="d-flex">
                          <form action="{{ URL::signedRoute('personal-parser-bp') }}" method="post" class="mx-2">
                            @csrf
                          ...
                          <form action="{{ URL::signedRoute('personal-parser-bp-download') }}" method="post" class="mx-2">
                            @csrf
                            <input type="hidden" name="bulan_ini" value="{{ $bulan_ini_signed }}" readonly>
                  ...
                  <div class="row pt-1">
                    <div class="col-12 mb-3">
                      <h6>Status Bulan Lain Non A1</h6>

                      <div class="d-flex flex-column mb-3">
                        <div class="p-2">
                          @if (Auth::user()->employee->is_setuju)
                          <form action="{{ URL::signedRoute('personal-parser-bp-search') }}" method="post" class="border-primary mx-2 border p-2">
                            @csrf
                            <div class="row mb-2">
                              <div class="col">
                        ...
                        <div class="p-2">
                          @if (Auth::user()->employee->is_setuju)
                          <form action="{{ URL::signedRoute('personal-parser-bp-search-download') }}" method="post" class="border-warning mx-2 border p-2">
                            @csrf
                            <div class="row mb-2">
                              <div class="col">
                                <x-forms.floating-labels name="bulan" label="Bulan" required>
                            ...
                            <div class="row">
                              <div class="col">
                                <x-inputs.button type="submit" class="btn btn-secondary">
                                  Unduh
                                  <i class="fa-solid fa-download"></i>
                                </x-inputs.button>
                              </div>
                      ...
                      <h6>Status Bulan Lain A1</h6>
                      <div class="d-flex flex-column mb-3">
                        <div class="p-2">
                          @if (Auth::user()->employee->is_setuju)
                          <form action="{{ URL::signedRoute('aone-personal-parser-bp-search') }}" method="post" class="border-primary mx-2 border p-2">
                            @csrf
                            <div class="row mb-2">
                              <div class="col">
                                <x-forms.floating-labels name="bulan" label="Bulan" required>
                        ...
                        <div class="p-2">
                          @if (Auth::user()->employee->is_setuju === true)
                          <form action="{{ URL::signedRoute('aone-personal-parser-bp-search-download') }}" method="post" class="border-warning mx-2 border p-2">
                            @csrf
                            <div class="row mb-2">
                              <div class="col">
                                <x-forms.floating-labels name="bulan" label="Bulan" required>
