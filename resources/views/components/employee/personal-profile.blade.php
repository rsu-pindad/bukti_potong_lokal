              ...
              <div class="card-body p-4">
                ...
                <div id="judulIdentitasKepegawaian"
                  ...
                  <h6 class="d-flex justify-content-between">
                    ...
                    @if (Auth::user()->employee->is_edited === false)
                ...
                <div id="fakturPajak">
                  ...
                  <hr class="mb-4 mt-0">
                  <div class="row pt-1">
                    @if (!Auth::user()->employee->is_edited)
                    ...
                    <div class="col-12 mb-3">
                      ...
                      <p class="text-muted">
                        @if (Auth::user()->employee->is_edited === true)
                      <div class="d-flex">
                      ...
                      <div class="d-flex flex-column mb-3">
                        <div class="p-2">
                          ...
                          <form action="{{ URL::signedRoute('personal-parser-bp-search') }}"
                            method="post"
                            class="border-primary mx-2 border p-2">
                            @csrf
                            <div class="row mb-2">
                              <div class="col">
                        ...
                        <div class="p-2">
                          ...
                          <form action="{{ URL::signedRoute('personal-parser-bp-search-download') }}"
                            method="post"
                            class="border-warning mx-2 border p-2">
                            @csrf
                            <div class="row mb-2">
                              <div class="col">
                                <x-forms.floating-labels name="bulan"
