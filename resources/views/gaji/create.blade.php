                ...
                <div class="modal-body row">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_kelu') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_pend') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_jbt') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_alih') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_kesja') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_beras') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_rayon') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_makan') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_kes') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_sostek') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_dapen') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_hadir') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_bhy') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tj_lainnya') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('pot_dapen') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('pot_sostek') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('pot_kes') is-invalid @enderror"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('pot_swk') is-invalid @enderror"
