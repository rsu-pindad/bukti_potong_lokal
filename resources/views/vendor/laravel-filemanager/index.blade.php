...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ basset('vendor/laravel-filemanager/img/72px color.png') }}">
  ...
  <link rel="stylesheet" href="{{ basset('vendor/laravel-filemanager/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ basset('vendor/laravel-filemanager/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ basset('vendor/laravel-filemanager/css/mime-icons.min.css') }}">
  {{-- <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style> --}}
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  <link rel="stylesheet" href="{{ basset('/vendor/laravel-filemanager/css/lfm.css') }}">
</head>
<body>
  ...
  @basset('https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js')
  @basset('https://cdn.jsdelivr.net/npm/popper.js@1.12.3/dist/umd/popper.min.js')
  @basset('https://cdn.jsdelivr.net/npm/bootstrap@4.1.0/dist/js/bootstrap.min.js')
  @basset('https://cdn.jsdelivr.net/npm/jquery-ui-dist@1.12.1/jquery-ui.min.js')
  ...
  <script src="{{ basset('vendor/laravel-filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ basset('vendor/laravel-filemanager/js/dropzone.min.js') }}"></script>
  <script>
