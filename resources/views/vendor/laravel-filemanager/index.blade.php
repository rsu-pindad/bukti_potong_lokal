...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon"
          type="image/png"
          href="{{ asset('vendor/laravel-filemanager/img/72px color.png') }}">
    {{-- basset('https://cdn.jsdelivr.net/npm/bootstrap@4.1.0/dist/css/bootstrap.min.css') --}}
    {{-- basset('https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.5.0/css/all.min.css') --}}
    {{-- basset('https://cdn.jsdelivr.net/npm/jquery-ui-dist@1.12.1/jquery-ui.min.css') --}}
    <link rel="stylesheet"
    ...
    <link rel="stylesheet"
          href="{{ asset('vendor/laravel-filemanager/css/dropzone.min.css') }}">
    <link rel="stylesheet"
          href="{{ asset('vendor/laravel-filemanager/css/mime-icons.min.css') }}">
    <style>
      {!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}
    </style>
    {{-- Use the line below instead of the above if you need to cache the css. --}}
    {{-- <link rel="stylesheet"
          href="{{ asset('vendor/laravel-filemanager/css/lfm.css') }}"> --}}
  </head>

  <body>
    <nav id="nav"
         class="navbar sticky-top navbar-expand-lg navbar-dark">
      <a class="navbar-brand d-lg-block d-none"
         href="/">
        <i class="fas fa-home fa-fw"></i> PMU
      </a>
      <a id="to-previous"
         class="navbar-brand invisible-lg d-none d-lg-inline">
      ...
      <a id="current_folder"
         class="navbar-brand d-block d-lg-none"></a>
      <a id="loading"
         class="navbar-brand"><i class="fas fa-spinner fa-spin"></i></a>
      <div class="ml-auto px-2">
        <a id="multi_selection_toggle"
           class="navbar-link d-none">
          <i class="fa fa-check-double fa-fw"></i>
          <span class="d-none d-lg-inline">{{ trans('laravel-filemanager::lfm.menu-multiple') }}</span>
        </a>
      </div>
      <a class="navbar-toggler collapsed m-0 border-0 px-1 py-2"
    ...
    <nav id="actions"
         class="bg-light fixed-bottom border-top d-none">
      <a data-action="open"
         data-multiple="false"><i class="fas fa-folder-open"></i>{{ trans('laravel-filemanager::lfm.btn-open') }}</a>
      <a data-action="preview"
         data-multiple="true"><i class="fas fa-images"></i>{{ trans('laravel-filemanager::lfm.menu-view') }}</a>
      <a data-action="use"
         data-multiple="true"><i class="fas fa-check"></i>{{ trans('laravel-filemanager::lfm.btn-confirm') }}</a>
    </nav>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 id="myModalLabel"
                class="modal-title">{{ trans('laravel-filemanager::lfm.title-upload') }}</h4>
            <button type="button"
                    class="close"
                    data-dismiss="modal"
              ...
              <div id="attachment"
                ...
                <div class="controls text-center">
                  <div class="input-group w-100">
                    <a id="upload-button"
                       class="btn btn-primary w-100 text-white">{{ trans('laravel-filemanager::lfm.message-choose') }}</a>
                  </div>
                </div>
              </div>
              <input id='working_dir'
                     type='hidden'
                     name='working_dir'>
              <input id='type'
                     type='hidden'
    ...
    <div id="carouselTemplate"
         class="d-none carousel slide bg-light"
         data-ride="carousel">
      <ol class="carousel-indicators">
        <li data-target="#previewCarousel"
            data-slide-to="0"
            class="active"></li>
      </ol>
