...
<div class="max-w-full px-4 py-6 sm:px-4 lg:px-6 lg:py-10 mx-auto">
  ...
  <div class="bg-white rounded-xl shadow p-4 sm:p-7">
    ...
    <form action="{{ URL::signedRoute('aone-personal-parser-bp-search') }}"
    method="post">
    @csrf
    ...
    <div class="mt-5 flex justify-end gap-x-2">
      <a href="{{route('personal-parser-index')}}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gray-600 text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 disabled:opacity-50 disabled:pointer-events-none">
        Cari Bukan A1 ?
      </a>
    </div>
  </div>
...
<div class="max-w-full px-4 py-6 sm:px-4 lg:px-6 lg:py-10 mx-auto">
  ...
  <div class="bg-white rounded-xl shadow p-4 sm:p-7">
    ...
    <form action="{{ URL::signedRoute('aone-personal-parser-bp-search-download') }}"
    method="post">
    @csrf
