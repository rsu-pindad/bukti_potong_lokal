...
class PersonaliaEmployeeController extends Controller
{
    ...
    public function update(Request $request, $id_karyawan)
    {
        $validator = Validator::make(
            $request->only(['npp', 'npwp', 'nama', 'email', 'np_hp', 'st_ptkp', 'st_peg', 'masuk', 'keluar']),
            [
        ...
        try {
            ...
            notify()->success('Data pegawai berhasil diperbarui.', 'Bukti Potong');
    ...
    public function import(Request $request)
    {
        try {
            ...
            notify()->success('berhasil import data pegawai', 'Bukti Potong');
