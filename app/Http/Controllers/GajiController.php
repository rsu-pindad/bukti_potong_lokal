...
class GajiController extends Controller
{
        ...
        foreach ($gaji as $gj) {
            ...
            if(Carbon::parse($gj->tgl_gaji)->format('M') != 12 )
            {
                ...
                elseif($gj->st_ptkp == 'K3') // GOLONGAN C
                {
                    ...
                    {
                        $tarifpph21 = ($total_bruto * (125/100));
                    } 
                    ...
                    {
                        $tarifpph21 = ($total_bruto * (175/100));
                    } 
            ...
            do {
                ...
                // $totalTunjangan = $gj->tj_kelu + $gj->tj_pend + $gj->tj_jbt + $gj->tj_kesja + $gj->tj_makan + $gj->tj_sostek + $gj->tj_kes + $gj->tj_dapen + $gj->tj_hadir_18 + $gj->thr + $gj->bonus + $gj->lembur + $gj->kurang;
                ...
                $pkp = $netoSetahun - $tarifpph21 > 0 ? $netoSetahun - $tarifpph21 : 0;

                $pph21Setahun = $this->pph21_setahun($pkp);
                // $pph21Sebulan = $pph21Setahun / 12 > 0 ? $pph21Setahun / 12 : 0;
                $pph21Sebulan = $tarifpph21;
                $request->session()->put("pph21_$gj->npp", $pph21Sebulan);
    ...
    private function pph21_setahunNew($pkp)
    {
        if ($pkp <= 60000000) {
            $pph21Setahun = $pkp * 0.05;
        } elseif ($pkp > 60000000&& $pkp <= 250000000) {
