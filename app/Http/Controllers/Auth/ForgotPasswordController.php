...
class ForgotPasswordController extends Controller
{
    ...
    public function resetLink(Request $request)
    {
        ...
        try {
            ...
            if (!$karyawan) {
                notify()->warning('Npp tidak ditemukan.', 'Form Lupa Password');
            ...
            notify()->success('password reset berhasil dikirim.', 'Form Lupa Password');

            return to_route('login');
        } catch (\Throwable $th) {
            notify()->error('Terjadi kendala.', 'Form Lupa Password');
        }
    ...
    public function submitResetPassword(Request $request)
    {
        ...
        if (!$updatePassword) {
            notify()->warning('Token tidak valid.', 'Form Ganti Password');
        ...
        try {
            ...
            notify()->success('Password berhasil diperbarui', 'Form Ganti Password');

            return to_route('login');
        } catch (\Throwable $th) {
            notify()->error('Terjadi kendala.', 'Form Ganti Passowrd');
        }
